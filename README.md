...
5. run `npx hardhat run --network localhost scripts/deployHotel42NFT.js` to deploy our compiled smart contract to the local blockchain running on localhost
